...
(function () {
    ...
    const BUCKETS = [
        { id: 'action', get label() { return (globalThis.NorvaI18n?.t("ui_web_64cff1319d2f", { defaultValue: "Action" }) ?? 'Action'); } },
        { id: 'aventure', get label() { return (globalThis.NorvaI18n?.t("ui_web_9a3c16424750", { defaultValue: "Adventure" }) ?? 'Adventure'); } },
        { id: 'comedie', get label() { return (globalThis.NorvaI18n?.t("ui_web_85f1c8c8e324", { defaultValue: "Comedy" }) ?? 'Comedy'); } },
        { id: 'drame', get label() { return (globalThis.NorvaI18n?.t("ui_web_da72bf5bbca4", { defaultValue: "Drama" }) ?? 'Drama'); } },
        { id: 'scifi', get label() { return (globalThis.NorvaI18n?.t("ui_web_fb78fb739cfd", { defaultValue: "Sci-Fi & Fantasy" }) ?? 'Sci-Fi & Fantasy'); } },
        { id: 'horreur', get label() { return (globalThis.NorvaI18n?.t("ui_web_271a22f75d73", { defaultValue: "Horror" }) ?? 'Horror'); } },
        { id: 'thriller', get label() { return (globalThis.NorvaI18n?.t("ui_web_623cf66ba78f", { defaultValue: "Thriller & Crime" }) ?? 'Thriller & Crime'); } },
        { id: 'romance', get label() { return (globalThis.NorvaI18n?.t("ui_web_3bc3567a7fc6", { defaultValue: "Romance" }) ?? 'Romance'); } },
        { id: 'familial', get label() { return (globalThis.NorvaI18n?.t("ui_web_bd2d677b2ed4", { defaultValue: "Family" }) ?? 'Family'); } },
        { id: 'animation_kids', get label() { return (globalThis.NorvaI18n?.t("ui_web_e606ac593a68", { defaultValue: "Kids Animation" }) ?? 'Kids Animation'); } },
        { id: 'animation_adult', get label() { return (globalThis.NorvaI18n?.t("ui_web_2c512aa71e62", { defaultValue: "Adult Animation" }) ?? 'Adult Animation'); } },
        { id: 'kdrama', get label() { return (globalThis.NorvaI18n?.t("ui_web_a20fcbea9409", { defaultValue: "K-Drama" }) ?? 'K-Drama'); } },
        { id: 'telerealite', get label() { return (globalThis.NorvaI18n?.t("ui_web_fb8662781fb3", { defaultValue: "Reality TV" }) ?? 'Reality TV'); } },
        { id: 'documentaires', get label() { return (globalThis.NorvaI18n?.t("ui_web_551b890d09d2", { defaultValue: "Documentaries" }) ?? 'Documentaries'); } },
    ...
    function label(id, fallback = '') { return BUCKETS.find(b => b.id === id)?.label || fallback || BUCKETS.find(b => b.id === 'autres').label; }

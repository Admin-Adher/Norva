...
function shell(heading: string, bodyHtml: string, cta?: { label: string; url: string }, lang: "en" | "fr" = "en"): string {
  return renderEmailFrame({ artwork: 'support', title: heading, heading, preheader: heading, bodyHtml, cta, lang });
}

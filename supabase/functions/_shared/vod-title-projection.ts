...
function cleanSearchQuery(title: string): string {
  return String(title || "")
    ...
    .replace(/^(?:[A-Z]{2}[A-Z0-9]{0,3}|4K|8K|3D|2160P|1440P|1080P|720P|480P|360P|007)(?:-[A-Z0-9+]{1,6})*(?: [-–—▎▏▍▌│┃┆┊｜|] | -[A-Z0-9+]{1,6}- )/, "")
    .replace(/[\[({][^\])}]*[\])}]/g, " ")
...
function normalizeTitle(value: string, year: string | null = null) {
  ...
  const deprefixed = rawValue.replace(/^(?:[A-Z]{2}[A-Z0-9]{0,3}|4K|8K|3D|2160P|1440P|1080P|720P|480P|360P|007)(?:-[A-Z0-9+]{1,6})*(?: [-–—▎▏▍▌│┃┆┊｜|] | -[A-Z0-9+]{1,6}- )/, "");

...
© Norva`,
    ...
    html: renderEmailFrame({ title: subject, heading: "Your account has been deleted", preheader: "Access to your Norva account is now closed.",
      bodyHtml: `Access to your Norva account is now closed. Data directly associated with the account has been removed or de-identified according to our <a href="https://norva.tv/privacy.html" style="color:#60A5FA;text-decoration:underline">Privacy Policy</a>. Norva may retain limited records where required by law or for security, fraud prevention and billing.<br><br>If you did not request this, contact <a href="mailto:support@norva.tv" style="color:#60A5FA;text-decoration:underline">support@norva.tv</a> right away.`,
      noteHtml: `You can create a new account anytime at <a href="https://norva.tv" style="color:#60A5FA;text-decoration:underline">norva.tv</a>.`,
    }),
  };
}

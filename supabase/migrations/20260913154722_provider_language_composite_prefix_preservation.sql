-- Preserve explicit provider prefixes containing regional/category qualifiers.
-- AR-EG, AR-DOC-D and AF-EN are bounded supplier tags, not bracketed title prose.
begin;

-- Resolve only the audited NL | HINDI category hierarchy as a Hindi declaration.
-- NL is its market prefix, not a second audio track. Exact file observations stay
-- authoritative; EXYU remains a regional category without an audio-language alias.
begin;

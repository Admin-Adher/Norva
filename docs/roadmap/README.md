...
| 💸 **Upsell mensuel→annuel (2 rails)** | Référence ponctuelle — logique vérifiée + correctifs | [`2026-07-18-session-log.md`](./2026-07-18-session-log.md) (audit 21 constats confirmés : plan_change sécurisé avant paiement, MRR ×12 corrigé, PRODUCT_CHANGE proprement journalisé, remplacement Play natif, textes upgrade — ⚠️ migration + edge à déployer) |

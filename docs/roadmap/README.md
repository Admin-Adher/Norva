...
| 💸 **Upsell, tarifs dynamiques & promos** | Prix/promo à changer → carte « 💵 Tarifs web » de Finance | [`2026-07-18-session-log.md`](./2026-07-18-session-log.md) (audit upsell 21 constats corrigés + `billing_prices` source unique + promos événementielles avec badge/thèmes/visuel plein écran + incident cache immutable — tout déployé) · [`billing-status.md`](./billing-status.md) §2026-07-18 |

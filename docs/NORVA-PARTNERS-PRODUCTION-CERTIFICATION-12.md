...
| 11 | Sauvegarde, restauration et sécurité | **Finalisé dans la release.** Le hotfix post-`eda071e` est atomique ; la répétition physique vérifie 32 marqueurs, 164 routines, 19 relations et 110 assertions pgTAP ; les états sensibles doivent rester identiques. | Prédeploy vert sur restauration isolée, backup logique chiffré, base-backup post-migration, postdeploy vert et Advisors/lint du même SHA. |

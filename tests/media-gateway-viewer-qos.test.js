...
test('Gateway OCR background work is preemptible, tree-killed and re-queued without a terminal callback', () => {
...
test('Gateway language detection requires a signed LID scope and viewer subtitle work is bounded and fair', async () => {

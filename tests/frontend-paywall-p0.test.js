...
test('connected-product navigation links both shipped Android apps to their canonical Play Store listings', () => {
  ...
  assert.match(appHtml, /\/js\/app\.js\?v=60/);
});
...
test('all changed funnel assets use fresh cache keys', () => {
  ...
  assert.match(appHtml, /cloudApi\.js\?v=55/);
  assert.match(appHtml, /Settings\.js\?v=46/);
  assert.match(appHtml, /PartnersPage\.js\?v=5/);
  assert.match(appHtml, /profiles\.js\?v=13/);
  assert.match(appHtml, /billing-config\.js\?v=8/);
  assert.match(appHtml, /billing\.js\?v=17/);
  assert.match(appHtml, /HomePage\.js\?v=55/);
  assert.match(appHtml, /app\.js\?v=60/);
  assert.match(appJs, /AdminPage\.js\?v=102/);

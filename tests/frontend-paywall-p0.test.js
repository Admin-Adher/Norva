...
test('connected-product navigation links both shipped Android apps to their canonical Play Store listings', () => {
  ...
  assert.match(appHtml, /\/js\/app\.js\?v=67/);
});
...
test('all changed funnel assets use fresh cache keys', () => {
  ...
  assert.match(appHtml, /cloudApi\.js\?v=56/);
  assert.match(appHtml, /Settings\.js\?v=47/);
  assert.match(appHtml, /PartnersPage\.js\?v=6/);
  ...
  assert.match(appHtml, /app\.js\?v=67/);
  assert.match(appJs, /AdminPage\.js\?v=110/);

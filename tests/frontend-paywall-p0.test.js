...
test('connected-product navigation links both shipped Android apps to their canonical Play Store listings', () => {
  ...
  assert.match(appHtml, /\/js\/app\.js\?v=2479544d89/);
});
...
test('all changed funnel assets use fresh cache keys', () => {
  ...
  assert.match(appHtml, /cloudApi\.js\?v=69/);
  assert.match(appHtml, /Settings\.js\?v=55/);
  ...
  assert.match(appHtml, /app\.js\?v=2479544d89/);

...
test('connected-product navigation links both shipped Android apps to their canonical Play Store listings', () => {
  ...
  assert.match(appHtml, /\/js\/app\.js\?v=4ea3d10343/);
});
...
test('all changed funnel assets use fresh cache keys', () => {
  ...
  assert.match(appHtml, /Settings\.js\?v=d1ee96cc32/);
  ...
  assert.match(appHtml, /HomePage\.js\?v=4b8155eafa/);
  assert.match(appHtml, /app\.js\?v=4ea3d10343/);

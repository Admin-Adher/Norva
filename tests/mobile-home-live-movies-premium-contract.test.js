...
test('cache versions publish the changed phone surfaces', () => {
  ...
  assert.match(appHtml, /MoviesPage\.js\?v=55/);
  assert.match(appHtml, /SeriesPage\.js\?v=53/);
});

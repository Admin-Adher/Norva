...
router.get('/', async (req, res) => {
    ...
    console.log(`[Remux] Starting remux for: ${sanitizeErrorMessage(url)}`);
    ...
    console.log(`[Remux] Full command: ${ffmpegPath} ${sanitizeErrorMessage(args.join(' '))}`);

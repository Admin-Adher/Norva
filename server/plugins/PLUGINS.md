...
This directory allows you to extend the functionality of **Norva** without modifying the core source code. The server automatically detects and loads any `.js` file placed in this folder at startup.

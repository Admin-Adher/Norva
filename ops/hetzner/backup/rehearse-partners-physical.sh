...
readonly BASELINE_CONTRACT="26b3ffc"
...
readonly REFERRAL_VISIBILITY_MARKER_COMPLETE="1"
readonly REFERRAL_VISIBILITY_MARKER_PENDING="0"
readonly REFERRAL_VISIBILITY_DELETED_ACCOUNT_MARKER_COMPLETE="1"
...
proof_line "baseline_markers_verified=42"
...
select (
  case
    when routine_ids.private_oid is null then false
    else
      position(
...
DIDIT_SIGNED_REVIEW_GRACE_MARKER="$(
  capture_didit_signed_review_grace_marker \
...
REFERRAL_VISIBILITY_DELETED_ACCOUNT_MARKER="$(
  capture_referral_visibility_deleted_account_marker \
    2> "$RAW_DIR/referral-visibility-deleted-account-precondition.log"
)" || fail
...
if [[ "$REHEARSAL_MODE" == "predeploy" ]]; then
  # The audited 26b3ffc database already contains the referral projection.
  # Only the deleted-account visibility filter remains pending replay.
...
REFERRAL_VISIBILITY_DELETED_ACCOUNT_MARKER="$(
  capture_referral_visibility_deleted_account_marker \
    2> "$RAW_DIR/referral-visibility-deleted-account-postcondition.log"
)" || fail
MIGRATION_MARKERS="${MIGRATION_MARKERS}|${DEPLOYMENT_MANIFEST_EVENT_MARKER}|${FRICTIONLESS_MIGRATION_MARKERS}|${OWNER_RISK_MIGRATION_MARKER}|${MULTICURRENCY_MIGRATION_MARKERS}|${WEB_TAX_MIGRATION_MARKERS}|${OWNER_REVIEW_VALIDITY_MARKER}|${BOOTSTRAP_BOOLEAN_MARKER}|${DIDIT_GUIDED_PREFLIGHT_MARKER}|${FR_PILOT_USD_ALIGNMENT_MARKER}|${DIDIT_PREFLIGHT_REGISTRY_TRUTH_MARKER}|${DIDIT_CERTIFICATION_RPC_ALIAS_MARKERS}|${DIDIT_REVIEW_RECOVERY_MARKER}|${DIDIT_SIGNED_REVIEW_GRACE_MARKER}|${DIDIT_ORPHAN_PURGE_RECOVERY_MARKER}|${REFERRAL_VISIBILITY_MARKER}|${REFERRAL_VISIBILITY_DELETED_ACCOUNT_MARKER}"

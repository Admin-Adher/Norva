...
ROOT=pathlib.Path('/home/adrien/.norva/passive-live-canary-native-20260913')
PARENT=ROOT.parent/'enrichment-admission-20260913-retry1/deploy-enrichment-admission-20260913.py'
...
def main():
    ...
    name='norva-passive-live-canary-native-20260913';reason=None
    ...
    require(code==0 and reason is None and counts=={'tests':40,'pass':40,'fail':0,'skipped':0},'native_tests_failed')

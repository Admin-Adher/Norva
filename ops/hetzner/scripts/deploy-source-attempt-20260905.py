"""Explicit, scoped two-file rollout. No SQL, customer sends or gateway changes."""
import hashlib, json, os, pathlib, shutil, subprocess, sys, time, urllib.request

os.umask(0o077)
root = pathlib.Path('/home/adrien/.norva/source-attempt-20260905-r1')
expected = {
    '_shared/source-connection-attempt.mjs': '0fde8771564e8cecf3f8d1ec1da24d435092e26cd62887c88de22bd9228cf357',
    'norva-cloud/index.ts': '7eb3ae9a6a05e887f8d9ee3490ed54910f574f68f3331b40b7d850770ef9a463',
}

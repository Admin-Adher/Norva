...
ROOT = pathlib.Path('/home/adrien/.norva/resume-cache-retention-20260912')
CURRENT = ROOT.parent/'resume-reuse-20260912'
NATIVE = ROOT.parent/'resume-reuse-native-20260912-r4/native-proof.json'
IMAGE = 'norva-media-gateway:resume-cache-retention-20260912'
FILES = ('finitePlaybackRangeReuse.js',)
...
live = load('resume_retention_current', CURRENT/'deploy-resume-reuse-20260912.py')
op = load('resume_retention_supervisor', ROOT.parent/'scoped-passive-dormant-20260912/deploy-scoped-passive-dormant-20260912.py')
op.ROOT, op.NATIVE, op.FILES, op.IMAGE = ROOT, NATIVE, FILES, IMAGE
op.PREFIX = op.SERVICE+'-resume-cache-retention-20260912'
...
def stage():
    ...
    base_tag = 'norva-resume-cache-retention-base:20260912'
    ...
    paths += [CURRENT/name for name in ('plan.private.json', 'receipt.private.json', 'closed.private.json', 'deploy-resume-reuse-20260912.py')]

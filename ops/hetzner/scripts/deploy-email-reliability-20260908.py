"""Roll two email modules and three email-only flags; preserve every other live file/config."""
import hashlib,json,os,pathlib,shutil,subprocess,sys,time,urllib.request
os.umask(0o077)
root=pathlib.Path('/home/adrien/.norva/email-reliability-edge-20260908')
expected={
 'norva-lifecycle/index.ts':'94f837d69b98367a8ba8a42f8ae18c51bb23844442fe8fd208fd200e8968ba86',
 '_shared/lifecycle-email.ts':'49b91fda5c36b7782d253759c8c8d3b6e59d73192185c0538d6dfa96466f5115',
}
flags={'NORVA_LIFECYCLE_BILLING_LIVE':'true','NORVA_LC_DUNNING':'true','NORVA_LC_RENEWAL':'true'}
...
if phase=='stage':
 ...
 for rel,sha in expected.items():assert digest(source/rel)==sha,'Live source drift: '+rel
 for c in cs:
 ...
 try:
  ...
  print(json.dumps({'deployed':name,'healthy':True,'hashesVerified':True,'emailFlags':flags}))
 except Exception:

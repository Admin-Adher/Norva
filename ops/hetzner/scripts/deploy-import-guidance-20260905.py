"""Explicit, scoped import guidance rollout. No SQL, customer sends or gateway changes."""
import hashlib, json, os, pathlib, shutil, subprocess, sys, time, urllib.request

os.umask(0o077)
root = pathlib.Path('/home/adrien/.norva/import-guidance-20260905-r1')
expected = {
    '_shared/import-email.ts': 'ca57cce22114b8f1139fc60cbb74f4d4ee7772d047e0d6649c83b5f0c0ef3aa2',
    '_shared/xtream-sync.ts': 'c54fa42cc310163a996a586bc1e8b95e9fa878cb1390802c08a42f8160bc59f3',
    'norva-import-notify/index.ts': 'a12e2e26d546d7a79ad5c31ba9df2d4d86c80518c4a8a641d0e702661dc63611',
}

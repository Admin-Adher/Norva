...
ROOT = pathlib.Path('/home/adrien/.norva/initial-playback-topology-20260912')
CURRENT = ROOT.parent/'initial-playback-idr-retry-20260912'
NATIVE = ROOT.parent/'initial-playback-index-native-20260912-r9/native-proof.json'
IMAGE = 'norva-media-gateway:initial-playback-topology-20260912'
...
live = load('initial_topology_current', CURRENT/'retry-idr-deploy.py').m
op = load('initial_topology_supervisor', ROOT.parent/'scoped-passive-dormant-20260912/deploy-scoped-passive-dormant-20260912.py')
op.ROOT, op.NATIVE, op.FILES, op.IMAGE = ROOT, NATIVE, FILES, IMAGE
op.PREFIX = op.SERVICE+'-initial-playback-topology-20260912'
...
def stage():
    ...
    require(proof.get('exitCode') == 0 and proof.get('counts') == {'tests':112, 'pass':111, 'fail':0, 'skipped':1}
    ...
    paths += [CURRENT/name for name in ('plan.private.json', 'receipt.private.json', 'closed.private.json', 'retry-idr-deploy.py')]

        ...
        instrumentation.runOnMainSync(() -> {
            ...
            view.setWebViewClient(new WebViewClient() {
                @Override public WebResourceResponse shouldInterceptRequest(WebView webView, WebResourceRequest request) {
                    try {
                        if ("/js/i18n.js".equals(request.getUrl().getPath())) {
                            return new WebResourceResponse("text/javascript", "UTF-8", instrumentation.getContext().getAssets().open("js/i18n.js"));
                        }
            ...
            String html = "<!doctype html><html><head><meta charset='UTF-8'><script src='/js/i18n.js'></script></head>"
                + "<body><h1 data-i18n='ui_settings'>Settings</h1><p id='provider' translate='no'>Provider Français العربية</p></body></html>";

...
/**
 * Closed authentication policy for the in-memory native playback channel.
 *
 ...
 * not expire through GoTrue rotation. Refresh tokens deliberately remain in
 * the trusted WebView and never cross the JavaScript/native boundary.</p>
 */
